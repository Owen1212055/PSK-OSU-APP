...
class APIService {
    ...
    // Pledge Points API
    async getAllPledgePoints(): Promise<PledgePointStanding[]> {
        return this.authGet<PledgePointStanding[]>(`${API_BASE_URL}/pledgepoints`);
    }

    async getAllPledgePointRequests(): Promise<PledgePointEntry[]> {
        return this.authGet<PledgePointEntry[]>(`${API_BASE_URL}/pledgepoint-requests`);
    }

    async createPledgePointRequest(request: Pick<PledgePointEntry, "reason" | "points" | "pledgeId">): Promise<PledgePointEntry> {
        return this.authPost<PledgePointEntry>(`${API_BASE_URL}/pledgepoint-requests`, request);
    }

    async approvePledgePointRequest(id: number): Promise<PledgePointEntry> {
        return this.authPut<PledgePointEntry>(`${API_BASE_URL}/pledgepoint-requests/${id}/approve`);
    }

    async denyPledgePointRequest(id: number): Promise<PledgePointEntry> {
        return this.authPut<PledgePointEntry>(`${API_BASE_URL}/pledgepoint-requests/${id}/deny`);
    }
